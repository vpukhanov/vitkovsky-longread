    ...
    <div>
      ...
      <div className={styles.textContainer}>
        <main className={styles.innerTextContainer}>
          ...
          <blockquote>
            <p>
              Мы знаем, что <b>вы невиновны</b> и{' '}
              <b>ничего не сделали плохого</b>. Но вы немного неустойчивы, вам
              лучше пожить вне Москвы, например, в Енисейске.{' '}
              <b>Вы молоды, здоровы, вам везде будет хорошо.</b>
            </p>
            <footer>
          ...
          <p>
            26 марта 1926 года <b>
              арестован как «родственник генерала Витковского,
              начальника штаба армии Петра Врангеля»
            </b>, хотя родственником этого
